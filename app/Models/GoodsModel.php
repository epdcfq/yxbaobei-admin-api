...
class GoodsModel extends BaseModel
{
     ...
     * 
     */
    // protected $fillable = ['org_id','title','summary','cover_pic', 'show_cover_pic','cate_id','cate_pids','start_time','end_time','imp_star','tag_ids', 'tag_names','author_id','author','status', 'published', 'published_platids', 'created_at', 'updated_at'];
    ...
    {
        return $this->hasOne(\App\Models\GoodsArticleModel::class, 'goods_id', 'id');
    }
    public function product()
    {
        return $this->hasOne(\App\Models\GoodsProductModel::class, 'goods_id', 'id');
    }
